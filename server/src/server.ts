...
app.get('/health', (req: Request, res: Response) => {
  res.status(200).json({
    status: 'success',
    message: 'Stella says: The server is alive , Rishav. Never underestimate a tiny projects because tiny ones when combined make things bigger and that will actually blow minds.',
  });
});
